...
## Day 19 2023/10/27
  ...
  开始看第四章,动态内存与页表的这些概念以前也都没有怎么接触过,看一半左右但还是半知半解的.
  
## Day 20 2023/10/28

  白天看完了第四章剩下的内容,对转移到地址空间的分时多任务系统的各个概念有了大概的认知,然后晚上开始看代码的实现,理解了下各个模块的结合与应用.
...
## Day 22 2023/10/30
  ...
  用空闲看了半天代码还是没有什么进展,对虚拟地址转换到实际的物理地址的操作不是很理解,用了很多种方法实现都过不了第一个gettime的点,能拿来用的几个函数get_mut,get_bytes_buffer这些拿来用了但很多时候还是很奇怪,不是编译错误就是不知道怎么实现.
  
## Day 23 2023/10/31

  经过队友的启发,对物理地址还有字节的这些基础的概念有了点新的理解,终于找到了转换虚拟地址和物理地址的方法,这么多天终于有了进展,写完了sys_get_time 和 sys_task_info.

## Day 24 2023/11/1

  看了下剩下的mmap 和 munmap的相关代码后没多久就完成了要求.然后开始看实验五的书.

## Day 25 2023/11/2
  花了一整天调完了ch5的代码,比起前面两个要号顺利很多.
## Day 26 2023/11/3
  写了下ch5的报告和简答题,还有进第三阶段的总结报告
## Day 27 2023/11/4
